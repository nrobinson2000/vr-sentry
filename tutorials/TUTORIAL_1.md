# Tutorial 1: Preparing the Raspberry Pi Sentry

> If you already have a Raspberry Pi running the latest Raspberry Pi OS with support enabled for the camera and I2C, please skip to Step 7.
